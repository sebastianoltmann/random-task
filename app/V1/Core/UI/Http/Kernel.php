...
namespace App\V1\Core\UI\Http;

use App\V1\Core\Infrastructure\Packeges\Sanctum\Middlewares\EnsureFrontendRequestsAreStateful;
use App\V1\Core\UI\Http\Middleware\ForceJsonResponse;
